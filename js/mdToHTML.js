...
function readTheFile() {
    ...
    let markdownContainer = document.getElementsByClassName('stackedit__html')[0];
        ...
        str     = '<!DOCTYPE html>\
                <html>\
                    ...
                    <body class="stackedit"><div class="stackedit__html">' +
                        document.getElementsByClassName('stackedit__html')[0].innerHTML + 
                    '</div></body>\
                </html>',
